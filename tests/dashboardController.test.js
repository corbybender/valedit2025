...
let moduleUnderTest;
try {
    moduleUnderTest = require('../src/controllers/dashboardController.js');
} catch {
    try {
        (async () => {
            moduleUnderTest = await import('../src/controllers/dashboardController.js');
        })();
    } catch (err) {
...
describe('dashboardController module', () => {
