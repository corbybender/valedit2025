...
let moduleUnderTest;
try {
    moduleUnderTest = require('../src/controllers/websiteController.js');
} catch {
    try {
        (async () => {
            moduleUnderTest = await import('../src/controllers/websiteController.js');
        })();
    } catch (err) {
...
describe('websiteController module', () => {
