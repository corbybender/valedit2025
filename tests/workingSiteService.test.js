...
let moduleUnderTest;
try {
    moduleUnderTest = require('../src/services/workingSiteService.js');
} catch {
    try {
        (async () => {
            moduleUnderTest = await import('../src/services/workingSiteService.js');
        })();
    } catch (err) {
...
describe('workingSiteService module', () => {
